...
const Footer = () => (
  <footer className="bg-grey-100 pt-28 pb-2 px-[7%] bg-[url(../images/left.svg),_url(../images/right.svg)] bg-no-repeat bg-left-right bg-contain text-white-10 flex flex-col gap-10 items-center">
